...
## 개요
2023 윈도우 프로그래밍 텀 프로젝트로 제작한 C언어와 Windows API를 사용한 간단한 2D 타이쿤 게임

## 제작 목적
C언어와 Windows API를 이용해 간단한 2D 게임을 제작해보며 C언어와 Windows API 학습과 동시에 팀프로젝트 경험해보도록 한다.
...
또한 프로젝트 폴더 내의 fmod.dll을 최신화 해주셔야 합니다.
